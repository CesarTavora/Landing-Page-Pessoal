...
<p>O projeto é estruturado nas seguintes seções:</p>
<ul>
...
<ul>
  ...
  <li>Efeitos visuais com gradientes, brihlos e sombras de texto</li>
    <div style="text-align: center; margin: 20px 0;">
  <img src="src/lp-links.gif" width="500" alt="Preview da Landing Page responsiva">
  </div>
  <li>Adaptação completa para dispositivos móveis via Media Queries</li>
  <div style="text-align: center; margin: 20px 0;">
  <img src="src/responsive-lp.gif" width="300" alt="Preview da Landing Page responsiva">
</div>
...
<h2>👨‍💻 Autor</h2>
<p>
  Desenvolvido por <strong>Cesar Tavora</strong><br>
